...
public class MyTaZQLListener extends TaZQLBaseListener {
	...
	@Override public void enterQuestions(TaZQLParser.QuestionsContext ctx) {
		System.out.println("enter questions");
	}
	
	@Override public void exitQuestions(TaZQLParser.QuestionsContext ctx) {
		System.out.println("exit questions");
	}
	
	@Override public void enterQuestion(TaZQLParser.QuestionContext ctx) { 
		
		System.out.println("enter question" + ctx.toString());
